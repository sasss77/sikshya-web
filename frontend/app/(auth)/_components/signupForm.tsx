...
import { registerAction, googleLoginAction } from "@/lib/actions/auth-action";
...
export default function SignupForm() {
  ...
  const handleGoogleLogin = useGoogleLogin({
    onSuccess: async (tokenResponse) => {
      ...
      try {
        ...
        if (result.success) {
          ...
          setServerStatus({ type: "error", message: result.message || "Google login failed. Please try again." });
        }
      } catch {
        setServerStatus({ type: "error", message: "Google login failed. Please try again." });
      } finally {
    ...
    onError: (error) => {
      ...
      setServerStatus({ type: "error", message: "Google sign-in was cancelled or failed. Please try again." });
    },
    flow: "implicit",
  });
          ...
          <div style={styles.formWrapper}>
            ...
            <form onSubmit={handleSubmit(onSubmit)} style={styles.form}>
              ...
              <div style={styles.fieldGroup}>
                ...
                <div style={{...styles.inputRow, ...(errors.phoneNumber ? styles.inputErrorRow : {})}}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#aaa" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}>
