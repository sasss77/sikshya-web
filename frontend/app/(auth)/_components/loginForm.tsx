...
import { loginAction, googleLoginAction } from "@/lib/actions/auth-action";
    ...
    onSuccess: async (tokenResponse) => {
      ...
      try {
        ...
        if (result.success) {
          ...
          setServerError(result.message || "Google login failed. Please try again.");
        }
      } catch {
...
// ── Added error & dynamic styling items seamlessly into your original object ──
